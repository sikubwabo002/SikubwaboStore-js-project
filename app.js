            ...
            if (name === key2) {
                ...
                swal({
                    ...
                    text: "Category : " + "( " + products[key][key2].category + " )  "
                        ...
                        + " --- Stock  : ( " + products[key][key2].stock + " ) "
                        + " --- Size : ( " + products[key][key2].sizes + " ) "
                        + " --- Price : ( Rwf." + products[key][key2].price + " ) ",
                    textColor: "red",
                    imageUrl: src,
                    imageWidth: 300,
                    imageHeight: 250,
                ...
                for (var key2 in products[key]) {
                    if (nameProduct === key2) {
                        ...
                        swal({
                            type: "success",
                            title: "SOLD!",
                            text: "Product " + products[key][key2].name + " has been Sold. Total Price : " + quantity + "X" + products[key][key2].price + "= RWF." + quantity * products[key][key2].price + "." + "THANKS!",
                        })
                        var soldd = {
                            date: DATE,
                            name: NAME,
...
function insertData(id) {
    ...
    if (id === "footwears") {
        ...
        var priceText = document.createTextNode("RWF." + price);
    ...
    if (id === "clothes") {
        ...
        var priceInfo = document.createElement("p");
        priceInfo.setAttribute("class", "proInfo");
        var priceText = document.createTextNode("RWE." + price);
        priceInfo.appendChild(priceText);
        mainDiv.appendChild(priceInfo);
        var editBtn = document.createElement("button");
        editBtn.setAttribute("class", "adminBtnsEdit");
...
function soldList() {
    ...
    for (var i = 0; i < b.length; i++) {
        ...
        var tpTdText = document.createTextNode("RWF." + TP);
    ...
    document.getElementById("saleTotal").innerHTML = "RWF." + tp;
}
soldList()
